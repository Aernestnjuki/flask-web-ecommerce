# contains all admin related codes
...
from .form import ShopItemsForm, OrderForm
...
def add_shop_items():
    if current_user.id == 1:
        ...
        if form.validate_on_submit():
            ...
            file_name = secure_filename(file.filename) # this removes the unwanted spaces in the image string
